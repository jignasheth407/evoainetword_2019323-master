				...
				<div class="column col-md-10 col-sm-9 col-xs-11 main-dashcontent" id="main">  
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="bd pd-t-30 pd-b-20 pd-x-20" id="chart_3">
                            ...
                            <div class="row">
                                <div class="col-sm-10 col-sm-offset-1"><button class="btn btn-success btn-block" id="activateExch">Activate Exchange</button><p>This button activates a particular exchange.</p></div>
                            </div><br>
                            <div class="row">
                                <div class="col-sm-10 col-sm-offset-1"><button class="btn btn-primary btn-block" id="addMarkets">Add Markets</button><p>This button adds markets ( pairs of the exchange ) for the selected exchange.</p></div>
                            </div><br>
                            <div class="row">
                                <div class="col-sm-10 col-sm-offset-1"><button class="btn btn-danger btn-block" id="deactivateExch">Deactivate Exchange</button><p>This button deactivates a particular exchange.</p></div>
                            </div>
...
-->							</div>
							<div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <div class="form-group mt-30 mb-30">
        							...
        							<select id="activeExch" class="form-control">
            							<option class="drop-bg" label="Select Exchange"></option>
        							</select>
    							</div>												
							</div>
                        ...
                        <div class="col-sm-4">
							...
							<div class="table-wrap">
								<div class="table-responsive">
									<table id="ExBalTable" class="table table-bordered dataTable no-footer" >
				    	...
				    	<div class="col-sm-8">
				    	    <div class="row">
            						...
            						<div class="panel panel-default card-view" style="background-color:black">
            							...
            							<div class="row">
            								<div class="panel-body" >
                                                ...
                                                <button class="form-control" type="sumbit">Place Buy Order</button>
                                                <span></span>
                                                <br>
                                                </form>
            								</div>
        						...
        						<div class="panel panel-default card-view" style="background-color:black" >
        							<div class="panel-heading" >
        								<div class="pull-left">
        									<h6 class="panel-title txt-dark">SELL - <span class="symbol"></span> <a href="#" class="refresh1" style="font-size:16px;margin-left:198px"><i class="fa fa-refresh"></i></a></h6>
        								</div>
        								<div class="clearfix"></div>
        							</div>
        							<div class="row">
        								<div class="panel-body" >
                                            ...
                                            <button class="form-control" type="sumbit">Place Sell Order</button>
                                            <span></span>
                                            <br>
                                            </form>
        								</div>
