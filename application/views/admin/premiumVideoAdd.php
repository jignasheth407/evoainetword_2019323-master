								...
								<div class="box-body">
									<div class="row">
										<div class="form-group col-md-5">
											<div class="input text">
												<label>Title</label>
												<input name="title" class="form-control" type="text" id="title" value="<?php echo set_value('title'); ?>">	
									...
									<div class="row">
										<div class="form-group col-md-4">
											<div class="input text">
												<label>URL</label>
												<input name="url" type="text" class="form-control" id="url" value="<?php echo set_value('url'); ?>">												
