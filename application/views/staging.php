<section class="header desk-header" id="top">
    ...
    <!--//--> 
    <section class="simple-section services evoai-section"> 
        <div id="band" class="container-fluid text-center">
            <div class="row clearfix">
                <div class="col-sm-12 animatable fadeInUp">
                    <h2 class="bg-title">The EVOAI Videos</h2>
                    <h2 class="section-title">The EVOAI Videos</h2>                    
                </div>
                <div class="col-md-12 box-shadow padT30 padB30">
                    <div class="owl-theme" id="owl-demo">  
						<?php
							if($video_list)
							{
								foreach($video_list as $res)
								{
									if($this->Ref_UserID)
									{
										?>
											<div class="item">
												<div align="center" class="embed-responsive embed-responsive-16by9">
													<video autoplay="false" class="embed-responsive-item" poster="<?php echo base_url(); ?>evoai/public/webroot/frontend/videos/<?php echo  $res->full_video; ?>" controls>
														<source src="<?php echo base_url(); ?>evoai/public/webroot/frontend/videos/<?php echo  $res->full_video; ?>" type="video/mp4" />
													</video>
												</div>
											</div>
										<?php
									...
									else
									{
										?>
											<div class="item">
												<div align="center" class="embed-responsive embed-responsive-16by9">
													<video preload="none" autoplay="false" class="embed-responsive-item" poster="<?php echo base_url(); ?>evoai/public/webroot/frontend/videos/<?php echo  $res->short_video; ?>" controls>
														<source src="<?php echo base_url(); ?>evoai/public/webroot/frontend/videos/<?php echo  $res->short_video; ?>" type="video/mp4" />
													</video>
												</div>
											</div>
										<?php
							...
							else
							{
								?>
									<div class="item">
										<div align="center" class="embed-responsive embed-responsive-16by9">
											<video autoplay="false" preload="none" class="embed-responsive-item" poster="<?php echo base_url();?>webroot/frontend/images/video_bg.png" controls>
												<source src="<?php echo base_url();?>webroot/frontend/videos/EVOAI-0uKwgbFYFNE8_beta.mp4" type="video/mp4" />
											</video>
										</div>
									</div>
									<div class="item">
										<div align="center" class="embed-responsive embed-responsive-16by9">
											<video autoplay="false" class="embed-responsive-item" poster="<?php echo base_url();?>webroot/frontend/images/video_bg.png" controls>
												<source src="<?php echo base_url();?>webroot/frontend/videos/EVOAI-0uKwgbFYFNE8_beta.mp4" type="video/mp4" />
											</video>
										</div>
									</div>
    ...
    <section class="simple-section services services-section" id="about">
        <div id="band" class="container-fluid text-center">
            <div class="row">
                <div class="col-sm-12 animatable fadeInUp">
                    <h2 class="bg-title">Evoai Intel</h2>
                    <h2 class="section-title">Evoai Intel</h2>
                </div>
            </div>
            <!--Evoaiintel table-->
            <div class="row clearfix">
					...
					<div class="row">
                    	<div class="col-md-12">
        					<ul class="nav nav-pills">
        					    <li class="active">
									<a class="btn-buy tickersLink" data-toggle="pill" href="#tickersDiv">Tickers</a>
								</li>
        					    <li>
									<?php
										if($this->Ref_UserID)
										{
											?>
												<a class="btn-buy tickersTopLink" data-toggle="pill" href="#tickersTopDiv">Top 20 Tickers</a>
											<?php
										}
										else
										{
											?>
												<a class="btn-buy" href="<?php echo base_url('login'); ?>">Top 20 Tickers</a>
											<?php
										}
									?>
								</li>
        					    <li>
									<?php
										...
										{
											?>
												<a class="btn-buy tickersBottomLink" data-toggle="pill" href="#tickersBottomDiv">Bottom 20 Tickers</a>
											<?php
										}
										else
										{
											?>
												<a class="btn-buy" href="<?php echo base_url('login'); ?>">Bottom 20 Tickers</a>
											<?php
										}
									?>
								</li>
                                <li>
									<?php
										...
										{
											?>
												<a class="btn-buy watchlistLink" data-toggle="pill" href="#watchlistDiv">Watchlist</a>
											<?php
										}
										else
										{
											?>
												<a class="btn-buy" href="<?php echo base_url('login'); ?>">Watchlist</a>
											<?php
										}
									?>									
								</li>
                                <li>
									<?php
										...
										{
											?>
												<a class="btn-buy signalsLink" data-toggle="pill" href="#signalsDiv">Alerts/Signals</a>
											<?php
										}
										else
										{
											?>
												<a class="btn-buy" href="<?php echo base_url('login'); ?>">Alerts/Signals</a>
											<?php
										}
									?>
								</li>
